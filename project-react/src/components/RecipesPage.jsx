                ...
                <div className="menu-container">
                    <div className="card">
                        ...
                        <div className="card-content">
                            <h3>Adobo Chicken</h3>
                            <p>Adobo Chicken is a popular Filipino dish <br />made with chicken, soy sauce, vinegar, <br />and garlic.</p>
                    ...
                    <div className="card">
                        ...
                        <div className="card-content">
                            <h3>Sinigang</h3>
                            <p>Sinigang is a Filipino soup <br /> characterized by its sour and savory taste, <br />often made with pork .</p>
                    ...
                    <div className="card">
                        ...
                        <div className="card-content">
                            <h3>Pancit</h3>
                            <p>Pancit is a Filipino noodle dish <br />that is often served during celebrations <br />and family gatherings.</p>
                    ...
                    <div className="card">
                        ...
                        <div className="card-content">
                            <h3>Dinuguan</h3>
                            <p>Dinuguan is a savory Filipino stew <br />made with pork, vinegar, and pig's blood.</p>
                    ...
                    <div className="card">
                        ...
                        <div className="card-content">
                            <h3>Sisig</h3>
                            <p>Sisig is a Filipino dish <br />made from parts of pig head and liver, <br />seasoned with calamansi, onions, <br />and chili peppers.</p>
